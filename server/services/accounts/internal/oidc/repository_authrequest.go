...
func (r *AuthRequestRepository) Create(ctx context.Context, ar *AuthRequest) error {
...
func (r *AuthRequestRepository) GetByID(ctx context.Context, id string) (*AuthRequest, error) {
...
func (r *AuthRequestRepository) GetByCode(ctx context.Context, code string) (*AuthRequest, error) {
	return r.scanOne(ctx,
		`SELECT id, client_id, redirect_uri, state, nonce, scopes, response_type, response_mode,
		        code_challenge, code_challenge_method, prompt, max_age, login_hint,
		        user_id, auth_time, amr, is_done, code, created_at
...
func (r *AuthRequestRepository) scanOne(ctx context.Context, query string, args ...any) (*AuthRequest, error) {
