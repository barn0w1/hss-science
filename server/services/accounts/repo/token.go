...
func (r *TokenRepository) GetByID(ctx context.Context, tokenID string) (*model.Token, error) {
...
func (r *TokenRepository) scanToken(row *sqlx.Row) (*model.Token, error) {
	var t model.Token
...
func (r *TokenRepository) scanRefreshToken(row *sqlx.Row) (*model.RefreshToken, error) {
